...
$to = "kazuki.tachibana@ikkei-spl.com";
...
$Referer_check_domain = "ドメイン（ikkei-spl.com）";
...
$require = array('お名前','電話番号','メールアドレス','連絡方法');
...
$refrom_name = "医マケ|-医療機関専門のSNS運用代行サービス";
...
お問い合わせありがとうございます。
問い合わせ内容を確認し、ご返信致しますので今しばらくお待ち下さい。
...
──────────────────────
株式会社IKKEI
E-mail:kazuki.tachibana@ikkei-spl.com
URL:https://ikkei-spl.com/
──────────────────────
